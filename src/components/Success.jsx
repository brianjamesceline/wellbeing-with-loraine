    ...
    <div className="max-w-screen-xl mx-auto">
      ...
      <div className="flex flex-wrap gap-4 justify-center ml-5 mr-5">
        <div className="box-content h-[320px] w-[250px] border border-emerald-500 mb-5 pl-3 pt-0 pr-3 pb-0 rounded-lg">
          <div>
            <img className="pt-4 pb-3" src="/images/Apostrophe1.jpg" />
          </div>
          ...
          <div className="flex justify-end">
            <img className="pt-0 pb-12" src="/images/Apostrophe2.jpg" />
          </div>
          <div className="">
        ...
        <div className="box-content h-[320px] w-[250px] border border-emerald-500 mb-5 pl-3 pt-0 pr-3 pb-0 rounded-lg">
          ...
          <p className="font-montserrat font-light text-[13px] text-left pb-2 text-slate">
      ...
      <div>
        <div className="flex justify-center mb-10">
          <button
            type="button"
            class="mr-0 mb-0 text-jade bg-white border border-jade font-montserrat rounded-lg text-[18px] px-5 py-2.5"
          >
            See More Stories
          </button>
        </div>
